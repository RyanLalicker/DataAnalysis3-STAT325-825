...
In search of another model, we considered a multinomial logistic regression.  The model predicts Calving Ease based on third trimester treatment, sex of the calf, and their interaction.
...
#| echo: false
#| eval: true
#| fig-cap: "Multinomial logistic regression output."
...
Another important thing is that multinomial logistic regression is designed to model nominal data, which is categorical data without an order.  (@Multi).
